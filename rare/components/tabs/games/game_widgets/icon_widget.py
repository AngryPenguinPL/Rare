...
class IconWidget(object):
    ...
    def setupUi(self, widget: QWidget):
        ...
        # self.title_label.setStyleSheet("background-color: rgba(0, 0, 0, 0%); color: white;")
        ...
        # self.status_label.setStyleSheet("background-color: rgba(0, 0, 0, 0%); color: white;")
        ...
        # self.launch_btn.setStyleSheet("border-color: black; border-width: 1px;")
        ...
        # self.install_btn.setStyleSheet("border-color: black; border-width: 1px;")
        ...
        # self.mini_widget.setObjectName(f"{type(self).__name__}_mini_widget")
        ...
        # image_layout.setObjectName(f"{type(self).__name__}_image_layout")
        # mini_layout.setObjectName(f"{type(self).__name__}_mini_layout")
        # row_layout.setObjectName(f"{type(self).__name__}_row_layout")
